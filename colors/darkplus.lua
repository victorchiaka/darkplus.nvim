...
-- darkplus.lua - VS Code Dark+ theme for Neovim (Exact Replica)
-- Place this file in: ~/.config/nvim/colors/darkplus.lua
...
-- EXACT VS Code Dark+ color palette
local colors = {
	bg = "#1e1e1e",
	fg = "#d4d4d4",
	bg_dark = "#252526",
...
-- Treesitter (Base highlights that work for all languages)
hl("@comment", { fg = colors.comment, italic = true })
hl("@string", { fg = colors.string })
hl("@number", { fg = colors.number })
hl("@boolean", { fg = colors.boolean })
...
-- UNIVERSAL: Keywords that should be BLUE across all languages
-- These apply the same color treatment Python had to ALL languages
hl("@keyword.function", { fg = colors.keyword_function }) -- def, func, function, fn, etc.
hl("@keyword.coroutine", { fg = colors.keyword_function }) -- async, await, etc.
hl("@keyword.return", { fg = colors.keyword_function }) -- return statement
hl("@keyword.operator", { fg = colors.keyword_function }) -- instanceof, typeof, etc.

-- UNIVERSAL: Storage/declaration keywords (class, interface, struct, enum, etc.)
hl("@keyword.type", { fg = colors.keyword_function }) -- class, interface, struct, enum
hl("@storageclass", { fg = colors.keyword_function }) -- static, extern, etc.
...
-- These provide additional coverage for languages where treesitter might use different capture names

-- Python specific (kept for backward compatibility)
hl("@keyword.function.python", { fg = colors.keyword_function })
hl("@keyword.coroutine.python", { fg = colors.keyword_function })
hl("PythonClassKeyword", { fg = colors.keyword_function })
hl("PythonImportedName", { fg = colors.function_name })
...
-- C/C++
hl("@keyword.function.c", { fg = colors.keyword_function })
hl("@keyword.function.cpp", { fg = colors.keyword_function })
...
-- Ruby
hl("@keyword.function.ruby", { fg = colors.keyword_function })

-- Java
hl("@keyword.function.java", { fg = colors.keyword_function })

-- C#
hl("@keyword.function.cs", { fg = colors.keyword_function })

-- PHP
hl("@keyword.function.php", { fg = colors.keyword_function })

-- Lua
hl("@keyword.function.lua", { fg = colors.keyword_function })

-- UNIVERSAL AUTOCMD for all languages
-- This ensures "class" and similar keywords get the blue color treatment
vim.api.nvim_create_autocmd("FileType", {
	...
	callback = function(ev)
		vim.defer_fn(function()
			...
			if ft == "" or ft == "help" or ft == "qf" then
				return
			end

			vim.api.nvim_buf_call(ev.buf, function()
				-- Apply syntax rules based on filetype
				if ft == "python" then
					vim.cmd([[
						syntax keyword PythonClassKeyword class contained containedin=ALL
						highlight! PythonClassKeyword guifg=#569cd6
				...
				then
					vim.cmd([[
						syntax keyword JSClassKeyword class contained containedin=ALL
						highlight! JSClassKeyword guifg=#569cd6
						syntax keyword JSFunctionKeyword function async contained containedin=ALL
						highlight! JSFunctionKeyword guifg=#569cd6
					]])
				elseif ft == "java" then
					vim.cmd([[
						syntax keyword JavaClassKeyword class interface enum contained containedin=ALL
						highlight! JavaClassKeyword guifg=#569cd6
					]])
				elseif ft == "c" or ft == "cpp" then
					vim.cmd([[
						syntax keyword CClassKeyword class struct union contained containedin=ALL
						highlight! CClassKeyword guifg=#569cd6
					]])
				elseif ft == "rust" then
					vim.cmd([[
						syntax keyword RustClassKeyword struct enum trait impl contained containedin=ALL
						highlight! RustClassKeyword guifg=#569cd6
						syntax keyword RustFunctionKeyword fn async contained containedin=ALL
						highlight! RustFunctionKeyword guifg=#569cd6
					]])
				elseif ft == "go" then
					vim.cmd([[
						syntax keyword GoClassKeyword struct interface contained containedin=ALL
						highlight! GoClassKeyword guifg=#569cd6
						syntax keyword GoFunctionKeyword func contained containedin=ALL
						highlight! GoFunctionKeyword guifg=#569cd6
					]])
				elseif ft == "ruby" then
					vim.cmd([[
						syntax keyword RubyClassKeyword class module contained containedin=ALL
						highlight! RubyClassKeyword guifg=#569cd6
						syntax keyword RubyFunctionKeyword def contained containedin=ALL
						highlight! RubyFunctionKeyword guifg=#569cd6
					]])
				elseif ft == "php" then
					vim.cmd([[
						syntax keyword PHPClassKeyword class interface trait contained containedin=ALL
						highlight! PHPClassKeyword guifg=#569cd6
						syntax keyword PHPFunctionKeyword function contained containedin=ALL
						highlight! PHPFunctionKeyword guifg=#569cd6
					]])
				elseif ft == "cs" then
					vim.cmd([[
						syntax keyword CSharpClassKeyword class interface struct enum contained containedin=ALL
						highlight! CSharpClassKeyword guifg=#569cd6
					]])
				elseif ft == "lua" then
					vim.cmd([[
						syntax keyword LuaFunctionKeyword function contained containedin=ALL
						highlight! LuaFunctionKeyword guifg=#569cd6
					]])
				end
			end)
		end, 100)
